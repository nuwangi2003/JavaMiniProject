...
public class StudentEligibilityDTO {
    ...
    public StudentEligibilityDTO(String studentId, String regNo, String studentName,
                                 String courseId, String courseCode, String courseName,
                                 double totalHours, double attendedHours,
                                 double attendancePercentage, String eligibilityStatus) {
