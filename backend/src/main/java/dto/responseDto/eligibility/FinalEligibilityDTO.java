...
public class FinalEligibilityDTO {
    ...
    public double getFinalAttendanceHours() {
        return finalAttendanceHours;
    }

    public void setFinalAttendanceHours(double finalAttendanceHours) {
        this.finalAttendanceHours = finalAttendanceHours;
    }
    ...
    public double getCaMaxMarks() {
        return caMaxMarks;
    }

    public void setCaMaxMarks(double caMaxMarks) {
    ...
    public String getFinalEligibilityStatus() {
        return finalEligibilityStatus;
    }

    public void setFinalEligibilityStatus(String finalEligibilityStatus) {
        this.finalEligibilityStatus = finalEligibilityStatus;
    }
}