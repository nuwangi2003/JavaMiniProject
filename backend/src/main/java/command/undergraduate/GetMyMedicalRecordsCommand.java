...
public class GetMyMedicalRecordsCommand implements Command {

    private final UndergraduateViewService service;
    private final ObjectMapper mapper = new ObjectMapper();

    public GetMyMedicalRecordsCommand(UndergraduateViewService service) {
    ...
    public void execute(Object data, ClientContext context) {
        try {
            ...
            MyDataResponseDTO response = new MyDataResponseDTO(
                    true,
                    "My medical records retrieved.",
                    service.getMyMedicalRecords(context.getUserId())
            );
