...
public class GetMyTimetableCommand implements Command {

    private final UndergraduateViewService service;
    private final ObjectMapper mapper = new ObjectMapper();

    public GetMyTimetableCommand(UndergraduateViewService service) {
    ...
    public void execute(Object data, ClientContext context) {
        try {
            ...
            Object timetable = service.getMyTimetable(context.getUserId());
            MyDataResponseDTO response = new MyDataResponseDTO(
                    timetable != null,
                    timetable != null ? "My timetable retrieved." : "No timetable found.",
                    timetable
            );
